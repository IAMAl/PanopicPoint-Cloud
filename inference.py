...
DEFAULT_OUTPUT_DIR = os.path.join(HOME_DIR, 'depth_img')
...
def _run_inference():
  ...
  with sv.managed_session() as sess:
    ...
    if FLAGS.kitti_video == 'test_files_eigen':
      ...
      video_path = os.path.join(FLAGS.kitti_video)
      #video_path = os.path.join(FLAGS.kitti_dir, FLAGS.kitti_video)
      im_files = os.listdir('../vid2depth_tf2_backup/kitti-raw-uncompressed/2011_09_26/2011_09_26_drive_0001_sync/image_02/data/')
      #im_files = gfile.glob(os.path.join(FLAGS.kitti_dir, 'image_02/data', '*.png'))
    ...
    for i in range(0, len(im_files), FLAGS.batch_size):
      ...
      for b in range(FLAGS.batch_size):
        ...
        if idx >= len(im_files):
          break
        im = imageio.imread('../vid2depth_tf2_backup/kitti-raw-uncompressed/2011_09_26/2011_09_26_drive_0001_sync/image_02/data/'+im_files[idx])
      ...
      for b in range(FLAGS.batch_size):
        ...
        if FLAGS.kitti_video == 'test_files_eigen':
          ...
          depth_path = os.path.join('../detectron2_demo/depth_img', str(im_files[idx]))
